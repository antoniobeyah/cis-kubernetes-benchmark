...
apiserver = attribute('apiserver', default: 'kube-apiserver', description: 'the process name of the apiserver')
...
control 'cis-kubernetes-benchmark-1.1.1' do
  ...
  describe apiserver_process.commands.to_s do
...
control 'cis-kubernetes-benchmark-1.1.17' do
  ...
  audit_log_maxage = apiserver_process.commands.to_s.scan(/--audit-log-maxage=(\d+)/)
...
control 'cis-kubernetes-benchmark-1.1.18' do
  ...
  audit_log_maxbackup = apiserver_process.commands.to_s.scan(/--audit-log-maxbackup=(\d+)/)
...
control 'cis-kubernetes-benchmark-1.1.19' do
  ...
  audit_log_maxsize = apiserver_process.commands.to_s.scan(/--audit-log-maxsize=(\d+)/)
